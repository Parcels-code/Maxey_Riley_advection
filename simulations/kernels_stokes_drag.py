...
def MRAdvectionEC_2D(particle, fieldset, time):
    """
    Advection of particles using Maxey-Riley equation in 2D with Stokes drag,
    without Basset history term, lift force, Faxen corrections and sinking or
    floating force. The equation is numerically integrated using the Euler-
    Cromes scheme.
...
def MRAdvectionRK4_2D(particle, fieldset, time):
    """
    Advection of particles using Maxey-Riley equation in 2D with Stokes drag
    without lift force, history force, Faxen correctiond and sinking of
    floating force. The equation is numerically integrated using the 4th order
    runge kutta scheme for a 2nd order ODE equation. We appromate the time 
    derivative at t (1rst step rk4) with a forward finite difference and the
    time derivative at t+delta_t (4th step rk4) with a backward finite difference.
